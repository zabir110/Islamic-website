<%@ Page Language="C#" AutoEventWireup="true" CodeFile="hamd.aspx.cs" Inherits="tilawat" %>
...
<head runat="server">
    ...
    <style>
        body {
            ...
            background-image: url('images/blurred-hd-background_1.jpg');
            color: #FFFFFF;
        }
        .center-div
{
...
<div  class=" content-padding" >
   ...
   <h2 class="text-center" style="color:white" ><strong>Hamd</strong></h2>
...
<div class="center-div">
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString2 %>" SelectCommand="SELECT * FROM [hvideo]"></asp:SqlDataSource>
          <table class="nav-justified" >
              <tr>
                  <td class="auto-style11">Vedio name</td>
              ...
              <tr>
                  <td class="auto-style11">Upload file</td>
                  <td class="auto-style2">
         ...
         <%} %>
          ...
          <div class=" content-padding" >
               ...
               <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString3 %>" SelectCommand="SELECT * FROM [hvideo]"></asp:SqlDataSource>
