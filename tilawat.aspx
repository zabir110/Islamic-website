<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tilawat.aspx.cs" Inherits="tilawat" %>
...
<head runat="server">
    ...
    <style>
        body {
            ...
            background-image: url('images/depth-of-field-wallpaper-hd-1.jpg');
            color: #FFFFFF;
        }
        .center-div
{
...
<div  class=" content-padding" >
   ...
   <h2 class="text-center" style="color:white" ><strong>Tilawat</strong></h2>
...
<div class="center-div">
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString2 %>" SelectCommand="SELECT * FROM [videodetails]"></asp:SqlDataSource>
