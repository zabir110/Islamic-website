<%@ Page Language="C#" AutoEventWireup="true" CodeFile="hadith.aspx.cs" Inherits="hadith" %>
    ...
    <title></title>
       <style>
        body {
            ...
            background-image: url(images/grand-mosque-abu-dhabi-wallpaper-full-hd-islam-image-wallpaper-1920-1080.jpg);
...
<body data-spy="scroll" data-target=".navbar" data-offset="50">
   ...
   <h2 class="text-center" style="color:white" ><strong>Books</strong></h2>
         ...
         <div class="center-div">
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString2 %>" SelectCommand="SELECT * FROM [hadith]"></asp:SqlDataSource>
          <table class="nav-justified" >
              <tr>
                  <td class="auto-style11">Book name</td>
              ...
              <tr>
                  <td class="auto-style11">Upload book</td>
                  <td class="auto-style2">
                      <asp:FileUpload ID="FileUpload2" runat="server" Height="34px" Width="256px" CssClass="auto-style3" />
                  </td>
              </tr>
              <tr>
          ...
          <%} %>
            ...
            <div class=" content-padding" >
               ...
               <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString3 %>" SelectCommand="SELECT * FROM [hadith]"></asp:SqlDataSource>
              
               <asp:DataList ID="DataList1" runat="server" DataKeyField="BookID" DataSourceID="SqlDataSource1" RepeatColumns="1" RepeatDirection="Horizontal" ShowFooter="False" ShowHeader="False" style="margin-top: 63px" RepeatLayout="Flow">
                  <ItemTemplate>
                      ...
                      <table class="auto-style1">
                          ...
                          <tr>
                              <td style="text-align: center" class="auto-style7">
                                  ...
                                  <asp:Label ID="Label3" runat="server" Text='<%# Eval("Bookname") %>'></asp:Label></h4>
                              </td>
                          </tr>
                          <tr>
