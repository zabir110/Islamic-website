...
public partial class tilawat : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        path = path.Replace(" ", "");
        FileUpload1.SaveAs(Server.MapPath("~/bvideo/") + path);
        String downloadlink = "bvideo/" + path;


        string  link = "<video width=470 height=328 controls><source src=" + downloadlink + " type=video/mp4></video>";
        String query = "Insert into bvideo(Vedioname,AuthorName,vediolink,dpath) values('" + TextBox1.Text + "','" + TextBox2.Text + "','" + link + "','" + downloadlink+ "')";
